...
function getEmailWrapper(content, orderId = null) {
  ...
  const PORTAL_LOGIN_URL = `${LOGIN}?from_url=${encodeURIComponent(APP + "/")}`;
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div class="email-container">
        ...
        <div class="content">
          ${content.replaceAll("__PORTAL_LOGIN_URL__", PORTAL_LOGIN_URL)}
        </div>
        ...
        <div class="footer">
          ...
          <div class="footer-text">
            For support, contact us at dinars@dinarexchange.co.nz
          </div>
          <div class="footer-text">
            Telephone (NZ): 64 9 872 4693
          </div>
...
export function tplMissing(kind, order) {
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="__PORTAL_LOGIN_URL__" class="cta-button">
    ...
    <div class="message">
      ...
      Simply reply to this email or contact us at dinars@dinarexchange.co.nz
    </div>
  `;

...
export function CookieConsent() {
  ...
  return (
    <div className="fixed inset-0 z-50 sm:inset-x-0 sm:bottom-0 sm:top-auto">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
       

        <div className="inline-block align-bottom bg-white rounded-t-lg shadow-xl border border-gray-200 text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:rounded-lg">
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1 mr-4">
                ...
                >
                  ...
                  <ArrowPathIcon className={`w-4 h-4 ml-1 inline ${showDetails ? 'rotate-180' : ''}`} />
                </button>
              </div>

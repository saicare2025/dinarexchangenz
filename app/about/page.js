      ...
      <div className="bg-gradient-to-r from-blue-100 to-orange-100 min-h-screen py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-orange rounded-full mx-auto" />
            </motion.div>
            
            <motion.h1 
              variants={itemVariants}
              className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-orange bg-clip-text text-transparent mb-4"
            >
          ...
          <div className="space-y-20">
            ...
            >
              ...
              <motion.div
                className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border-l-4 border-orange shadow-lg"
                whileHover={{ y: -5 }}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="text-orange text-2xl mb-3">{index + 1}.</div>
            ...
            >
              <motion.div
                className="bg-gradient-to-r from-blue-600 to-orange p-0.5 rounded-full inline-block mb-8"
                whileInView={{ scaleX: [0, 1.2, 1] }}
                initial={{ scaleX: 0 }}
                transition={{ duration: 0.8 }}
              >
                <div className="bg-gradient-to-r from-blue-100 to-orange-100 px-8 py-4 rounded-full">
                  <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange">
                    Our Mission
                  </h2>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                >
                  <div className="text-orange text-3xl mb-4">✉️</div>
